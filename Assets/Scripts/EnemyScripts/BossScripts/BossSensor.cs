...
public class BossSensor : MonoBehaviour
{
    ...
    public void AlwayTowardToPlayer(){
        ...
        {
            tmpDirToTargetX = bossPathFindingMovement.currentVisualDir; // default value if the amount too small
        }
        
        int moveDirX = Math.Sign(tmpDirToTargetX);
        
        bossPathFindingMovement.currentVisualDir = bossPathFindingMovement.LeftOrRightPlatformer(moveDirX) == true ? 1 : -1;
    }
    ...
    private bool IsWallOrGroundTooHigh()
    {
        ...
        UnityEngine.Vector3 directScanning = bossPathFindingMovement.currentVisualDir == -1 ? UnityEngine.Vector3.left : UnityEngine.Vector3.right;
    ...
    public bool IsHole()
    {
        ...
        UnityEngine.Vector3 dir;
        dir = bossPathFindingMovement.currentVisualDir == -1 ? DownLeft : DownRight;
        UnityEngine.Vector3 StartPoint =  dir + (bossPathFindingMovement.currentVisualDir == -1 ? UnityEngine.Vector3.left : UnityEngine.Vector3.right) * 0.1f;
