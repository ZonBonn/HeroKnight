...
public class EnemyEWSensor : MonoBehaviour
{
    private EnemyEWPathFindingMovement enemyEWPathFindingMovement;
    private EnemyEWAI enemyEWAI;
    ...
    void Start()
    {
        ...
        enemyEWAI = gameObject.GetComponent<EnemyEWAI>();
    ...
    public void AlwayTowardToPlayer(){
        ...
        {
            tmpDirToTargetX = enemyEWPathFindingMovement.currentVisualDir; // default value if the amount too small
        }
        
        int moveDirX = Math.Sign(tmpDirToTargetX);
        
        enemyEWPathFindingMovement.currentVisualDir = enemyEWPathFindingMovement.LeftOrRightPlatformer(moveDirX) == true ? 1 : -1;
    }

    public bool IsSearchedPlayerAround() 
    {
        Vector3 EnemyPosition = gameObject.transform.position;
        Vector2 VisualDir = enemyEWPathFindingMovement.currentVisualDir == -1 ? Vector2.left : Vector2.right;
        Vector3 maxDistanceVisualPoint = VisualDir == Vector2.left ? enemyEWAI.chaseLeftPoint.position : enemyEWAI.chaseRightPoint.position;
        ...
        RaycastHit2D raycastHit2D = Physics2D.Raycast(EnemyPosition, VisualDir, DistanceVisual, enemyEWAI.playerLayerMask);
    ...
    {
        Vector3 dir = enemyEWPathFindingMovement.currentVisualDir == -1 ? Vector3.left : Vector3.right;
    ...
    private bool IsWallOrGroundInFront()
    {
        ...
        dir = enemyEWPathFindingMovement.currentVisualDir == -1 ? UnityEngine.Vector3.left : UnityEngine.Vector3.right;
    ...
    private bool IsWallOrGroundTooHigh()
    {
        ...
        UnityEngine.Vector3 directScanning = enemyEWPathFindingMovement.currentVisualDir == -1 ? UnityEngine.Vector3.left : UnityEngine.Vector3.right;
    ...
    public bool IsHole()
    {
        ...
        UnityEngine.Vector3 dir;
        dir = enemyEWPathFindingMovement.currentVisualDir == -1 ? DownLeft : DownRight;
        UnityEngine.Vector3 StartPoint =  dir + (enemyEWPathFindingMovement.currentVisualDir == -1 ? UnityEngine.Vector3.left : UnityEngine.Vector3.right) * 0.1f;
